      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mb-4">
              Locally manufactured mouse pads and PC accessories designed for
          ...
          <div>
            <h4 className="text-white text-lg font-bold mb-4">Shop</h4>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 text-center">
          <p>&copy; {new Date().getFullYear()} TechPad. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
